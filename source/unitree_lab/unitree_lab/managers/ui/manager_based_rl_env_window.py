...
class ManagerBasedSafeRLEnvWindow(BaseEnvWindow):
    ...
    def __init__(self, env: ManagerBasedSafeRLEnv, window_name: str = "IsaacLab"):
        ...
        with self.ui_window_elements["main_vstack"]:
            with self.ui_window_elements["debug_frame"]:
                with self.ui_window_elements["debug_vstack"]:
                    ...
                    self._visualize_manager(title="Cost", class_name="cost_manager")
