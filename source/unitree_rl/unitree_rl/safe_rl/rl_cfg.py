...
class RslRlPpoActorCriticCfg:
    ...
    obs_segments: list[str] = MISSING
    """The observation segments for the actor and critic networks."""
    
    privileged_obs_segments: list[str] = MISSING
    """The privileged observation segments for the actor and critic networks."""
...
@configclass
class RslRlP3oActorCriticCfg(RslRlPpoActorCriticCfg):
...
class RslRlPpoAlgorithmCfg:
    ...
    # estimator_cfg: RslRlEstimatorCfg | None = None
    # """The configuration for the estimator module. Default is None,
    # in which case the estimator is not used.
    # """

@configclass
class RslRlP3oAlgorithmCfg(RslRlPpoAlgorithmCfg):
    """Configuration for the P3O algorithm."""
