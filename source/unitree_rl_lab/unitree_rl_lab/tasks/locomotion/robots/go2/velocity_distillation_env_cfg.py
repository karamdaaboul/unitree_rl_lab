...
@configclass
class RobotDistillationEnvCfg(RobotEnvCfg):
...
@configclass
class RobotDistillationPlayEnvCfg(RobotDistillationEnvCfg):
    def __post_init__(self):
        super().__post_init__()
...
@configclass
class RobotDistillationKeyboardEnvCfg(RobotDistillationPlayEnvCfg):
