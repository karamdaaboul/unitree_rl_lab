...
from unitree_lab.managers import CostTermCfg as CostTerm
...
class CostCfg:
    ...
    dof_pos_limits = CostTerm(func=mdp.joint_pos_limits, weight=10.0)
...
@configclass
class RobotEnvCfg(ManagerBasedSafeRLEnvCfg):
